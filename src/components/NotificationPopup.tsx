            ...
            <ScrollView className="flex-1" showsVerticalScrollIndicator={true}>
              {activeNotifications.length === 0 ? (
                <View className="items-center justify-center py-12">
                  ...
                  <Text className="text-gray-400 text-xs mt-1">Create one in Admin → Notify</Text>
                </View>
              ) : (
                      ...
                      <View className="flex-row items-start">
                        ...
                        <View className="flex-1 ml-3">
                          <View className="flex-row items-center justify-between mb-1">
                            <Text className={`font-medium ${!notification.isRead ? 'text-gray-900' : 'text-gray-700'}`}>
                              {notification.title}
                            </Text>
                          ...
                          {!notification.isRead && (
                            <View className="w-2 h-2 bg-blue-500 rounded-full absolute -left-7 top-1" />
                          )}
                        </View>
                      </View>
                    </Pressable>
